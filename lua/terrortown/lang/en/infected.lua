...
If a player gets infected, the player becomes a zombie and is able to infect other players. This allows zombies to build up a whole army.
However, there is one thing you need to get in mind: If the host (the main infected player with a normal model) dies or disconnects, each player that the host directly infected will die.
